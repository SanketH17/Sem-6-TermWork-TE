...
# declaration of int, float variable (give space between two varaiable name)
# you can write any printf statement
# assignment of a value to variable should not be at the time of varaiable declration
